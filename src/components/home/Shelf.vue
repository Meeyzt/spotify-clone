  ...
  <div class="w-full">
      <div class="flex flex-row justify-between mb-4 gap-3">
        <div class="flex flex-col items-start truncate">
          <p class="text-white text-2xl hover:underline cursor-pointer font-bold tracking-tighter mr-2 truncate" v-text="title"/>
          <p class="text-normalColor text-sm font-normal truncate" v-if="subTitle != ''" v-text="subTitle"/>
        </div>
        <a class="text-normalColor text-xs hover:underline cursor-pointer font-bold tracking-widest pt-4 overflow-clip whitespace-nowrap">
          HEPSİNİ GÖR
        </a>
      </div>
